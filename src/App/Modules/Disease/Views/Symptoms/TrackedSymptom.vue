      ...
      <template v-slot:item.actions="{ item }">
        <div class="nowrap-buttons">
          ...
          <a
            ...
            data-animation="true"
            href="#"
            @click="deleteAlertDisplay({id: item.uuid, time: item.created_at})"
          >
...
export default {
  ...
  methods: {
    ...
    getTrackedSymptom() {
      ...
      let url =
        "symptom/doctor/symptoms/get-tracked-symptom/" + this.$route.params.uuid;
      this.$axios
        .get(url)
        .then((response) => {
    ...
    deleteTrackedSymptom(time,id) {
      ...
      let url ="symptom/doctor/symptoms/delete-tracked-symptom/" + id + "/" + time;
      this.$axios
        .post(url)
        .then((response) => {
