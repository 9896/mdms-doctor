...
export default {
  ...
  methods: {
    showTrackedSymptom() {
      ...
      let url = "symptom/doctor/symptoms/show-tracked-symptom/" + this.$route.params.uuid + "/" + this.$route.params.created_at;
    ...
    editTrackedSymptom() {
      ...
      let url = "symptom/doctor/symptoms/edit-tracked-symptom";
      this.$axios
        .post(url, {
